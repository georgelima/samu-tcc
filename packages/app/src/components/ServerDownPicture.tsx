...
export const ServerDownPicture = () => (
  <svg
  ...
  >
    ...
    <rect x='271.609' y='150' width='16' height='16' fill='tomato' opacity='0.4' />
    <rect x='294.609' y='150' width='16' height='16' fill='tomato' opacity='0.8' />
    <rect x='317.609' y='150' width='16' height='16' fill='tomato' />
    <rect x='271.609' y='251' width='16' height='16' fill='tomato' opacity='0.4' />
    <rect x='294.609' y='251' width='16' height='16' fill='tomato' opacity='0.8' />
    <rect x='317.609' y='251' width='16' height='16' fill='tomato' />
    <rect x='271.609' y='352' width='16' height='16' fill='tomato' opacity='0.4' />
    <rect x='294.609' y='352' width='16' height='16' fill='tomato' opacity='0.8' />
    <rect x='317.609' y='352' width='16' height='16' fill='tomato' />
